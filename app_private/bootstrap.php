...
function doc_registry(): array {
    return [
        ...
        'statement'=>['slug'=>'statement-template','label'=>'Client statement','title'=>'Statement of account template: summarise a customer account','kw'=>'statement of account template','h1'=>'Statement of account template',
            ...
            'fields'=>['Your business details','Customer details','Statement date and period','List of invoices with dates and amounts','Payments received','Opening and closing balance'],
...
function render_template_page(string $key): void {
    ...
    echo '<div class="actions"><a class="btn" href="/?doc='.e($key).'#invgen">Open the '.e(strtolower($d['label'])).' builder</a></div>';
    echo '<h2>When do you use a '.e(strtolower($d['label'])).'?</h2><p>'.e($d['when']).'</p>';
    echo '<h2>What should a '.e(strtolower($d['label'])).' include?</h2><ol class="doc-fields">';
...
function page_header(string $title, bool $app=true, ?string $description=null): void {
    ...
    { echo '<a href="/features.php">Features</a><a href="/pricing.php">Pricing</a><a href="/templates.php">Templates</a>'
        ...
        .'<a class="btn small" id="accessSignUp" href="/#invgen">Sign up</a>'
...
function page_footer(): void { echo '</main><footer><div class="footer-grid"><div><strong>'.e(APP_NAME).'</strong><p>Invoicing and business documents for any country. No payment processing.</p></div><div><strong>Generators</strong><a href="/templates.php">All templates</a><a href="/invoice-template.php">Invoice</a><a href="/tax-invoice-template.php">Tax invoice</a><a href="/commercial-invoice-template.php">Commercial invoice</a><a href="/proforma-invoice-template.php">Proforma invoice</a><a href="/quote-template.php">Quote</a><a href="/estimate-template.php">Estimate</a><a href="/sales-order-template.php">Sales order</a><a href="/deposit-invoice-template.php">Deposit invoice</a><a href="/progress-invoice-template.php">Progress invoice</a><a href="/final-invoice-template.php">Final invoice</a><a href="/receipt-template.php">Receipt</a><a href="/credit-note-template.php">Credit note</a><a href="/debit-note-template.php">Debit note</a></div><div><strong>More documents</strong><a href="/purchase-order-template.php">Purchase order</a><a href="/work-order-template.php">Work order</a><a href="/delivery-note-template.php">Delivery note</a><a href="/packing-slip-template.php">Packing slip</a><a href="/waybill-template.php">Waybill</a><a href="/goods-received-note-template.php">Goods received note</a><a href="/return-note-template.php">Return note</a><a href="/payment-reminder-template.php">Payment reminder</a><a href="/statement-template.php">Client statement</a><a href="/account-balance-letter-template.php">Account balance letter</a><a href="/completion-certificate-template.php">Completion certificate</a><a href="/timesheet-template.php">Timesheet</a><a href="/expense-report-template.php">Expense report</a></div><div><strong>Guides</strong><a href="/invoice_software_small_business.php">Small business invoicing</a><a href="/quote_and_invoice_software.php">Quotes and invoices</a><a href="/methodology.php">How it works</a><a href="/features.php">Features</a><a href="/pricing.php">Pricing</a><a href="/#invgen">Create a document</a></div><div><strong>Company</strong><a href="/contact.php">Contact</a><a href="/privacy.php">Privacy</a><a href="/terms.php">Terms</a></div></div><p class="footer-note">'.e(APP_NAME).' · '.e(APP_URL).'</p></footer><div class="cookie-banner" role="dialog" aria-label="Cookie choices" hidden><p>We use an essential cookie to remember that your email is verified on this browser. Optional preference storage remembers your theme and cookie choice.</p><div class="actions"><button data-cookie="essential">Essential only</button><button data-cookie="all" class="btn secondary">Allow preferences</button><a href="/privacy.php#cookies">Learn more</a></div></div><div class="sr-live" aria-live="polite" aria-atomic="true"></div><script src="/assets/vendor/jspdf.umd.min.js?v=63" defer></script><script src="/assets/vendor/html2canvas.min.js?v=63" defer></script><script src="/assets/pdf.js?v=63" defer></script><script src="/assets/export.js?v=63" defer></script><script src="/assets/signup.js?v=63" defer></script><script src="/assets/app.js?v=63" defer></script></body></html>'; }
